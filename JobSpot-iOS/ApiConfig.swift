...
class ApiConfig {
    let API_KEY = "Bearer imXBBrutJKGqrj6NHkLNPA41F8H/dbvQDiYjpaLrQWmYzJb+PNAZ7dg8D6Gv7onpkZl1mccgSRygH+xiE7AZrQ=="
    ...
    func useHeader() -> URL? {
        ...
        request.setValue("Bearer imXBBrutJKGqrj6NHkLNPA41F8H/dbvQDiYjpaLrQWmYzJb+PNAZ7dg8D6Gv7onpkZl1mccgSRygH+xiE7AZrQ==", forHTTPHeaderField: "Authorization")
    ...
    func getJobs() {
        ...
        Alamofire.request((createURLWithComponents()?.absoluteString)!).responseJSON { response in
